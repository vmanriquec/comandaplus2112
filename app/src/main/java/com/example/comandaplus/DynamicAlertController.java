...
class DynamicAlertController {
    ...
    private void setupView() {
        ...
        if (hasTopPanel) {
            ...
            if (contentPanel != null || customPanel != null) {
        ...
        if (mListView instanceof DynamicAlertController.RecycleListView) {
            ((DynamicAlertController.RecycleListView) mListView).setHasDecor(hasTopPanel, hasButtonPanel);
        }
